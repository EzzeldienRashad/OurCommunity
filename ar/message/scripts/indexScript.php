    ...
    fetch("arrays/comments.php")
        ...
        .then(function (comments) {
            ...
            for (let i = 1; i <= (comments.length > commentsCount ? commentsCount : comments.length); i++) {
                ...
                let commentDate = minutes < 1 ? "اﻵن" : minutes < 60 ? "من " + minutes + " دقائق" : 
                hours < 24 ? "من " + hours + " ساعات" : days < 30 ? "من " + days + " أيام" :
                months < 12 ? "من " + months + "أشهر" : "من " + years + " سنين";
                ...
                addC2cBtn.setAttribute("value", "+اضافة تعليق");
                ...
                addC2c.textContent = "+اضافة تعليق";
