...
<body>
    <header>
        ...
        <nav>
            ...
            <a href="../../../en" hreflang="en" lang="en" lang="en">English</a>
    ...
    <main>
        ...
        <h3><i class="fa-solid fa-arrow-down-long"></i><i class="fa-solid fa-arrow-down-long"></i> تحميل اﻵن <i class="fa-solid fa-arrow-down-long"></i><i class="fa-solid fa-arrow-down-long"></i></h3>
        <iframe frameborder="0" src="https://itch.io/embed/1721187?border_width=2" width="554" height="169">
            <a href="https://omar-ogp.itch.io/profissional-killer">Professional Killer بواسطة المبرمج عمر أشرف</a>
        </iframe>
        <h3><i class="fa-solid fa-arrow-up-long"></i><i class="fa-solid fa-arrow-up-long"></i> تحميل اﻵن <i class="fa-solid fa-arrow-up-long"></i><i class="fa-solid fa-arrow-up-long"></i></h3>
    </main>
    <footer>
